      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        >
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-600 rounded transition cursor-pointer ${
              speciality === "General physician"
          ...
          {filterDoc.map((doctor, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-gray-800 text-sm">{doctor.speciality}</p>
              </div>
            </div>
          ))}
        </div>
